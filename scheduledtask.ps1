...
$trigger =  New-ScheduledTaskTrigger -At 12am -Weekly -DaysOfWeek Sunday -WeeksInterval 3

Register-ScheduledTask -User 'nt authority\system' -Action $action -Trigger $trigger -TaskPath Terraform -TaskName "AppLog" -Description "Daily dump of Applog"
